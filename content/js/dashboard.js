    ...
    <table class="table" id="recital_${recital_number}">
        ...
        <thead>
            <tr>
                ...
                <th scope="col"><button class="btn btn-light btn-sm" type="button" title="Edit Recitals" style="float: right;" data-toggle="modal" data-target="#editRecitalsModal_${recital_number}">
